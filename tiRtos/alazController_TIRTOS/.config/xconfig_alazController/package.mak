...
override PKGDIR = xconfig_alazController
...
C:/ti/simplelink_msp432p4_sdk_2_40_00_10/kernel/tirtos/packages/ti/targets/ITarget.xs:
package.mak: C:/ti/simplelink_msp432p4_sdk_2_40_00_10/kernel/tirtos/packages/ti/targets/ITarget.xs
C:/ti/simplelink_msp432p4_sdk_2_40_00_10/kernel/tirtos/packages/ti/targets/C28_large.xs:
package.mak: C:/ti/simplelink_msp432p4_sdk_2_40_00_10/kernel/tirtos/packages/ti/targets/C28_large.xs
C:/ti/simplelink_msp432p4_sdk_2_40_00_10/kernel/tirtos/packages/ti/targets/C28_float.xs:
package.mak: C:/ti/simplelink_msp432p4_sdk_2_40_00_10/kernel/tirtos/packages/ti/targets/C28_float.xs
C:/ti/simplelink_msp432p4_sdk_2_40_00_10/kernel/tirtos/packages/ti/targets/package.xs:
package.mak: C:/ti/simplelink_msp432p4_sdk_2_40_00_10/kernel/tirtos/packages/ti/targets/package.xs
C:/ti/simplelink_msp432p4_sdk_2_40_00_10/kernel/tirtos/packages/ti/targets/arm/elf/IArm.xs:
package.mak: C:/ti/simplelink_msp432p4_sdk_2_40_00_10/kernel/tirtos/packages/ti/targets/arm/elf/IArm.xs
C:/ti/simplelink_msp432p4_sdk_2_40_00_10/kernel/tirtos/packages/ti/targets/arm/elf/package.xs:
package.mak: C:/ti/simplelink_msp432p4_sdk_2_40_00_10/kernel/tirtos/packages/ti/targets/arm/elf/package.xs
...
ti.targets.arm.elf.packageBase ?= C:/ti/simplelink_msp432p4_sdk_2_40_00_10/kernel/tirtos/packages/ti/targets/arm/elf/
...
package/%.xdc.inc package/%_xconfig_alazController.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_alazController" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: alazController.pem4f

-include package/cfg/alazController_pem4f.mak
-include package/cfg/alazController_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/alazController_pem4f.dep
endif
alazController.pem4f: package/cfg/alazController_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
alazController.pem4f package/cfg/alazController_pem4f.c: .libraries,em4f
endif

package/cfg/alazController_pem4f.c package/cfg/alazController_pem4f.h package/cfg/alazController_pem4f.xdl: override _PROG_NAME := alazController.xem4f
package/cfg/alazController_pem4f.c: package/cfg/alazController_pem4f.cfg
package/cfg/alazController_pem4f.xdc.inc: package/cfg/alazController_pem4f.xdl
package/cfg/alazController_pem4f.xdl package/cfg/alazController_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/alazController_pem4f.cfg
	-$(RM) package/cfg/alazController_pem4f.dep
	-$(RM) package/cfg/alazController_pem4f.c
	-$(RM) package/cfg/alazController_pem4f.xdc.inc

clean,em4f::
	-$(RM) alazController.pem4f
.executables,em4f .executables: alazController.xem4f

alazController.xem4f: |alazController.pem4f

-include package/cfg/alazController.xem4f.mak
alazController.xem4f: package/cfg/alazController_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/alazController_pem4f.oem4f   package/cfg/alazController_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
alazController.xem4f: export C_DIR=
alazController.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
alazController.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

alazController.test test,em4f test: alazController.xem4f.test

alazController.xem4f.test:: alazController.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 alazController.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.alazController.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,alazController.xem4f,*)


clean:: clean,em4f

clean,em4f::
	-$(RM) alazController.xem4f
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
alazController_pem4f.oem4f,copy : package/cfg/alazController_pem4f.oem4f
alazController_pem4f.sem4f,copy : package/cfg/alazController_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_alazController
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_alazController.tar.dep
endif
package/rel/xconfig_alazController/xconfig_alazController/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_alazController/xconfig_alazController/package/package.rel.xml: package/build.cfg
package/rel/xconfig_alazController/xconfig_alazController/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_alazController/xconfig_alazController/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_alazController.tar: package/rel/xconfig_alazController.xdc.inc package/rel/xconfig_alazController/xconfig_alazController/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_alazController.xdc.inc,package/rel/xconfig_alazController.tar.dep)


release release,xconfig_alazController: all xconfig_alazController.tar
clean:: .clean
	-$(RM) xconfig_alazController.tar
	-$(RM) package/rel/xconfig_alazController.xdc.inc
	-$(RM) package/rel/xconfig_alazController.tar.dep
