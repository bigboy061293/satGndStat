...
linker.cmd: package/cfg/uartlogging_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/uartlogging_pem4fcfg.cmd\)\"$""\"D:/vgu/satGndStat/tiRtos/uartlogging_MSP_EXP432P4111_tirtos_ccs/.config/xconfig_uartlogging/\1\""' package/cfg/uartlogging_pem4f.xdl > $@
