...
void systickInit(void)
{
    ...
    MAP_SysTick_setPeriod(15000); // this num/1.5Mhz = systick frequency
...
//
    MAP_GPIO_setAsInputPinWithPullDownResistor(GPIO_PORT_P3, GPIO_PIN6); //data in
